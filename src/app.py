...
activities = {
    ...
    "Track and Field": {
        "description": "Sprint, distance running, and track events",
...
def sign_up(activity_name: str, email: str):
    ...
    return {"message": f"{email} successfully signed up for {activity_name}"}  
